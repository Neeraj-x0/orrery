    ...
    neos: [
      {
        ...
        semiMajorAxis: 1.1 * NEO_ORBIT_SCALE,
        eccentricity: 0.191,
        inclination: (Math.PI * 3.331) / 180,
        longitudeOfAscendingNode: (Math.PI * 204.435) / 180,
        argumentOfPeriapsis: (Math.PI * 126.4) / 180,
        orbitalPeriod: 0.9 * TIME_SCALE,
      },
      {
        name: "Bennu",
        textureUrl: "/textures/2k_moon.jpg",
        radius: 0.05 * PLANET_SIZE_SCALE,
        semiMajorAxis: 1.2 * NEO_ORBIT_SCALE,
        eccentricity: 0.203,
      ...
      },
      {
        ...
        semiMajorAxis: 1.46 * NEO_ORBIT_SCALE,
        eccentricity: 0.223,
      ...
      },
      {
        ...
        semiMajorAxis: 3.9 * NEO_ORBIT_SCALE,
        eccentricity: 0.236,
      ...
      },
      {
        ...
        semiMajorAxis: 5.6 * NEO_ORBIT_SCALE,
        eccentricity: 0.534,
      ...
      },
      {
        ...
        textureUrl: "/textures/2k_moon.jpg",
        radius: 0.03 * PLANET_SIZE_SCALE,
        semiMajorAxis: 6.08 * NEO_ORBIT_SCALE,
        eccentricity: 0.827,
      ...
      },
      {
        ...
        textureUrl: "/textures/2k_moon.jpg",
        radius: 0.05 * PLANET_SIZE_SCALE,
        semiMajorAxis: 10.5 * NEO_ORBIT_SCALE,
        eccentricity: 0.255,
        inclination: (Math.PI * 12.978) / 180,
        longitudeOfAscendingNode: (Math.PI * 169.851) / 180,
        argumentOfPeriapsis: (Math.PI * 248.6) / 180,
        orbitalPeriod: 3.0 * TIME_SCALE,
      },
      {
        name: "Phaethon",
        textureUrl: "/textures/2k_moon.jpg",
        radius: 0.04 * PLANET_SIZE_SCALE,
        semiMajorAxis: 7.27 * NEO_ORBIT_SCALE,
        eccentricity: 0.890,
      ...
      },
      {
        ...
        textureUrl: "/textures/2k_moon.jpg",
        radius: 0.06 * PLANET_SIZE_SCALE,
        semiMajorAxis: 3.2 * NEO_ORBIT_SCALE,
        eccentricity: 0.633,
      ...
      },
      {
        name: "Vesta",
        textureUrl: "/textures/2k_moon.jpg",
        radius: 0.08 * PLANET_SIZE_SCALE,
        semiMajorAxis: 4.57 * NEO_ORBIT_SCALE,
        eccentricity: 0.089,
        inclination: (Math.PI * 7.140) / 180,
        longitudeOfAscendingNode: (Math.PI * 103.8) / 180,
        argumentOfPeriapsis: (Math.PI * 150.5) / 180,
        orbitalPeriod: 3.6 * TIME_SCALE,
      }
    ]
